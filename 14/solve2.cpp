...
// To compile optimized for speed: g++ -O3 -std=c++11 -o solve2 solve2.cpp
// To compile for code profiling: g++ -pg -std=c++11 -o solve2 solve2.cpp
...
// To use callgrind: valgrind --tool=callgrind --callgrind-out-file=callgrind.out ./solve2
...
string run_pair_insertions(string polymer) {
    ...
    for (int i = 0; i < polymer.size() - 1; i++) {
        ...
        if (pair_insertions->find(string(1, letter_1) + string(1, letter_2)) != pair_insertions->end()) {
